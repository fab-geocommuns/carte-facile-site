...
<head>
    ...
    <link href="../../../dist/component/callout/callout.legacy.css" rel="stylesheet">
    ...
    <link href="../../../dist/component/callout/callout.print.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Mise en avant (callout)</h1>
        <p>La mise en avant permet à l’utilisateur de distinguer rapidement une information qui vient compléter le contenu consulté.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/mise-en-avant" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Mise en avant avec texte seul</h3>
                    <div class="fr-mb-6v">
                        <div id="callout-5828" class="fr-callout">
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5830">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5830">
                                <pre class=" language-html"><code>&lt;div id="callout-5829" class="fr-callout"&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                    ...
                    <h3>Mise en avant avec titre et texte</h3>
                    <div class="fr-mb-6v">
                        <div id="callout-5831" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5833">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5833">
                                <pre class=" language-html"><code>&lt;div id="callout-5832" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <h3>Mise en avant avec titre, bouton et texte</h3>
                    <div class="fr-mb-6v">
                        <div id="callout-5834" class="fr-callout">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                            <button class="fr-btn" id="button-5835">
                                Label bouton
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5838">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5838">
                                <pre class=" language-html"><code>&lt;div id="callout-5836" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
    &lt;button class="fr-btn" id="button-5837"&gt;
        Label bouton
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <h3>Mise en avant avec titre, bouton, icône et texte</h3>
                    <div class="fr-mb-6v">
                        <div id="callout-5839" class="fr-callout fr-icon-info-line">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                            <button class="fr-btn" id="button-5840">
                                Label bouton
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5843">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5843">
                                <pre class=" language-html"><code>&lt;div id="callout-5841" class="fr-callout fr-icon-info-line"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
    &lt;button class="fr-btn" id="button-5842"&gt;
        Label bouton
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <h3>Mise en avant accentué</h3>
                    <div class="fr-mb-6v">
                        <div id="callout-5844" class="fr-callout fr-callout--green-emeraude">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-5846">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-5846">
                                <pre class=" language-html"><code>&lt;div id="callout-5845" class="fr-callout fr-callout--green-emeraude"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-5847">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-5848" title="Fermer">
                                Fermer
                            </button>
                        </div>
