...
<head>
    ...
    <link href="../../../dist/component/quote/quote.legacy.css" rel="stylesheet">
    ...
    <link href="../../../dist/component/quote/quote.print.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Citation (quote)</h1>
        <p>La citation permet de citer un texte dans une page éditoriale. La citation peut provenir d'un extrait d’un discours oral formulé par une tierce personne ou d’un texte écrit.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/citation" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Citation par défaut (texte taille xl)</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2009">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2009">
                                <pre class=" language-html"><code>&lt;figure class="fr-quote"&gt;
    &lt;blockquote cite="[À MODIFIER - https://lien-vers-la-source.fr]"&gt;
        &lt;p&gt;« Lorem [...] elit ut. »&lt;/p&gt;
    &lt;/blockquote&gt;
    &lt;figcaption&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2010">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2010">
                                <pre class=" language-html"><code>&lt;figure class="fr-quote"&gt;
    &lt;blockquote cite="[À MODIFIER - https://lien-vers-la-source.fr]"&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2011">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2011">
                                <pre class=" language-html"><code>&lt;figure class="fr-quote fr-quote--column"&gt;
    &lt;blockquote cite="[À MODIFIER - https://lien-vers-la-source.fr]"&gt;
        &lt;p&gt;« Lorem [...] elit ut. »&lt;/p&gt;
    &lt;/blockquote&gt;
    &lt;figcaption&gt;
...
&lt;/figure&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2012">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2012">
                                <pre class=" language-html"><code>&lt;figure class="fr-quote fr-quote--green-emeraude"&gt;
    &lt;blockquote cite="[À MODIFIER - https://lien-vers-la-source.fr]"&gt;
        &lt;p&gt;« Lorem [...] elit ut. »&lt;/p&gt;
    &lt;/blockquote&gt;
    &lt;figcaption&gt;
...
&lt;/figure&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-2013">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-2014" title="Fermer">
                                Fermer
                            </button>
                        </div>
