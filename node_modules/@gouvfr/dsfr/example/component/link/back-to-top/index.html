...
<body id="top" class="fr-mb-12w">
        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <div class="fr-mt-32v">
                        <h2>Retour en haut de page</h2>
                        <p>Le lien de “retour en haut de page” est une ancre vers un élément dont l’id est "top".
                            <br> Afin de le faire fonctionner correctement, il est nécessaire d’ajouter l’attribut id (id="top") sur l’élement le plus haut de la page comme le body (&lt;body id="top" ...&gt;) ou les liens d’évitement (&lt;div class="fr-skiplinks" id="top"&gt;), afin que le focus de navigation soit lui aussi replacé en haut de page.
                            <br>Le lien haut de page est un lien classique <code>fr-link</code> composé de l'icone <code>arrow-up-fill</code>, alignée à gauche, et du label "Haut de page".
                            <br>
                            <br>Le lien peut être aligné sur la gauche ou la droite du contenu.
                            <br>
                            <b>Actuce:</b> Pour aligner le lien à droite, l'insérer dans une <<code>div class="fr-grid-row fr-grid-row--right"></code>.
                        </p>
                    </div>
                    <h3>Lien Haut de page - id=&#34;top&#34;</h3>
                    <div class="fr-mb-6v">
                        <a class="fr-link fr-icon-arrow-up-fill fr-link--icon-left" id="link-4423" href="#top">Haut de page</a>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4425">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4425">
                                <pre class=" language-html"><code>&lt;a class="fr-link fr-icon-arrow-up-fill fr-link--icon-left" id="link-4424" href="#top"&gt;Haut de page&lt;/a&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-4426">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-4427" title="Fermer">
                                Fermer
                            </button>
                        </div>
