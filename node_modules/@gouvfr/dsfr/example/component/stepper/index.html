...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Indicateur d&#39;étapes (stepper)</h1>
        <p>L’indicateur d'étape permet d’indiquer à l’utilisateur où il se trouve dans un formulaire ou dans une démarche.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/indicateur-d-etapes" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <div class="fr-mt-0">
                        ...
                        <p>L'indicateur d'étape peut contenir de 2 à 8 étapes.
                            <br> Il doit être placé dans un conteneur de 6 à 8 colonnes de large en desktop, et 100% (12 colonnes) en mobile.
                            <br> Le niveau de titre h2 peut être modifié suivant le contexte
                        </p>
                    </div>
                    <h3>Exemple d&#39;indicateur d&#39;étape 1 sur 3</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4003">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4003">
                                <pre class=" language-html"><code>&lt;div class="fr-stepper"&gt;
    &lt;h2 class="fr-stepper__title"&gt;
        Titre de l’étape en cours
        &lt;span class="fr-stepper__state"&gt;Étape 1 sur 3&lt;/span&gt;
    &lt;/h2&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Exemple d&#39;indicateur d&#39;étape 2 sur 8</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-stepper">
                            <h2 class="fr-stepper__title">
                                Titre de l’étape en cours
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4004">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4004">
                                <pre class=" language-html"><code>&lt;div class="fr-stepper"&gt;
    &lt;h2 class="fr-stepper__title"&gt;
        Titre de l’étape en cours
        &lt;span class="fr-stepper__state"&gt;Étape 2 sur 8&lt;/span&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-4005">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-4006" title="Fermer">
                                Fermer
                            </button>
                        </div>
