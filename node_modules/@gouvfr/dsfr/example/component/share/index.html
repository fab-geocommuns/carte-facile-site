...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Partage (share)</h1>
        <p>Les boutons de partage permettent aux utilisateurs de partager facilement un contenu, via les réseaux sociaux, par envoi de mail ou en copiant l’URL du contenu dans le presse-papier.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/partage" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <div class="fr-mt-0">
                        <h2>Méta données</h2>
                        <p>Données à insérer dans la partie <code>
                                < head>
                            </code> de la page, pour fournir un aperçu de la page aux applications tierces lors du partage.</p>
                    </div>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6727">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-6727">
                                <pre class=" language-html"><code>&lt;meta name="twitter:card" content="summary_large_image"&gt;
&lt;meta name="twitter:site" content="[À MODIFIER - @usernameTwitter]"&gt;
&lt;meta property="og:title" content="[À MODIFIER - Système de Design de l&amp;#39;État]"&gt;
&lt;meta property="og:description" content="[À MODIFIER - Développer vos sites et applications en utilisant des composants prêts à l&amp;#39;emploi, accessibles et ergonomiques]"&gt;
&lt;meta property="og:image" content="[À MODIFIER - https://systeme-de-design.gouv.fr/src/img/systeme-de-design.gouv.fr.jpg]"&gt;
...
&lt;meta name="twitter:image:alt" content="[À MODIFIER - République Française - Système de Design de l&amp;#39;État]"&gt;
                    ...
                    <div class="fr-mt-0">
                        <h2>Boutons de partage par défaut</h2>
                        <p>Les icones réseaux sociaux disponibles pour ce composant sont définies dans :</p>
                    </div>
                    <div class="fr-mb-4v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6728">src/component/share/style/_setting.scss</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-6728">
...
$share-icons: (
  ...
  twitter-x: twitter-x-line
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-share" id="share-6729">
                            <p class="fr-share__title">Partager la page</p>
                            <ul class="fr-btns-group">
                                <li>
                                    <a class="fr-btn--facebook fr-btn" target="_blank" rel="noopener" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6730" onclick="window.open(this.href,'Partager sur Facebook','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=450'); event.preventDefault();" href="https://www.facebook.com/sharer.php?u=[À MODIFIER - url de la page]">
                                        Partager sur Facebook
                                    </a>
                                </li>
                                <li>
                                    <!-- Les paramètres de la reqûete doivent être URI-encodés (ex: encodeURIComponent() en js) -->
                                    <a class="fr-btn--twitter-x fr-btn" target="_blank" rel="noopener" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6731" onclick="window.open(this.href,'Partager sur X (anciennement Twitter)','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=420'); event.preventDefault();" href="https://twitter.com/intent/tweet?url=[À MODIFIER - url de la page]&text=[À MODIFIER - titre ou texte descriptif de la page]&via=[À MODIFIER - via]&hashtags=[À MODIFIER - hashtags]">
                                        Partager sur X (anciennement Twitter)
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--linkedin fr-btn" target="_blank" rel="noopener" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6732" onclick="window.open(this.href,'Partager sur LinkedIn','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=550,height=550'); event.preventDefault();" href="https://www.linkedin.com/shareArticle?url=[À MODIFIER - url de la page]&title=[À MODIFIER - titre ou texte descriptif de la page]">
                                        Partager sur LinkedIn
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--mail fr-btn" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6733" href="mailto:?subject=[À MODIFIER - objet du mail]&body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]">
                                        Partager par email
                                    </a>
                                </li>
                                <li>
                                    <button class="fr-btn--copy fr-btn" id="share-6734" onclick="navigator.clipboard.writeText(window.location).then(function() {alert('Adresse copiée dans le presse papier.')});">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6741">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-6741">
                                <pre class=" language-html"><code>&lt;div class="fr-share" id="share-6735"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;ul class="fr-btns-group"&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--facebook fr-btn" target="_blank" rel="noopener" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6736" onclick="window.open(this.href,'Partager sur Facebook','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=450'); event.preventDefault();" href="https://www.facebook.com/sharer.php?u=[À MODIFIER - url de la page]"&gt;
                Partager sur Facebook
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;!-- Les paramètres de la reqûete doivent être URI-encodés (ex: encodeURIComponent() en js) --&gt;
            &lt;a class="fr-btn--twitter-x fr-btn" target="_blank" rel="noopener" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6737" onclick="window.open(this.href,'Partager sur X (anciennement Twitter)','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=420'); event.preventDefault();" href="https://twitter.com/intent/tweet?url=[À MODIFIER - url de la page]&amp;text=[À MODIFIER - titre ou texte descriptif de la page]&amp;via=[À MODIFIER - via]&amp;hashtags=[À MODIFIER - hashtags]"&gt;
                Partager sur X (anciennement Twitter)
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--linkedin fr-btn" target="_blank" rel="noopener" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6738" onclick="window.open(this.href,'Partager sur LinkedIn','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=550,height=550'); event.preventDefault();" href="https://www.linkedin.com/shareArticle?url=[À MODIFIER - url de la page]&amp;title=[À MODIFIER - titre ou texte descriptif de la page]"&gt;
                Partager sur LinkedIn
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--mail fr-btn" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6739" href="mailto:?subject=[À MODIFIER - objet du mail]&amp;body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]"&gt;
                Partager par email
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;button class="fr-btn--copy fr-btn" id="share-6740" onclick="navigator.clipboard.writeText(window.location).then(function() {alert('Adresse copiée dans le presse papier.')});"&gt;
                Copier dans le presse-papier
            &lt;/button&gt;
        &lt;/li&gt;
    &lt;/ul&gt;
&lt;/div&gt;
                    ...
                    <h3>Boutons de partage version inactive</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-share" id="share-6742">
                            <p class="fr-share__title">Partager la page</p>
                            ...
                            <ul class="fr-btns-group">
                                <li>
                                    <a class="fr-btn--facebook fr-btn" id="share-6743" aria-disabled="true" role="link">
                                        Partager sur Facebook
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--twitter-x fr-btn" id="share-6744" aria-disabled="true" role="link">
                                        Partager sur X (anciennement Twitter)
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--linkedin fr-btn" id="share-6745" aria-disabled="true" role="link">
                                        Partager sur LinkedIn
                                    </a>
                                </li>
                                <li>
                                    <a class="fr-btn--mail fr-btn" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6746" href="mailto:?subject=[À MODIFIER - objet du mail]&body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]">
                                        Partager par email
                                    </a>
                                </li>
                                <li>
                                    <button class="fr-btn--copy fr-btn" id="share-6747" onclick="navigator.clipboard.writeText(window.location).then(function() {alert('Adresse copiée dans le presse papier.')});">
                                        Copier dans le presse-papier
                                    </button>
                                </li>
                            </ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6754">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-6754">
                                <pre class=" language-html"><code>&lt;div class="fr-share" id="share-6748"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;p class="fr-share__text"&gt;Veuillez &lt;a href=[À MODIFIER - url page autorisation cookies]&gt;autoriser le dépôt de cookies&lt;/a&gt; pour partager sur Facebook, Twitter et LinkedIn.&lt;/p&gt;
    &lt;ul class="fr-btns-group"&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--facebook fr-btn" id="share-6749" aria-disabled="true" role="link"&gt;
                Partager sur Facebook
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--twitter-x fr-btn" id="share-6750" aria-disabled="true" role="link"&gt;
                Partager sur X (anciennement Twitter)
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--linkedin fr-btn" id="share-6751" aria-disabled="true" role="link"&gt;
                Partager sur LinkedIn
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;a class="fr-btn--mail fr-btn" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre" id="share-6752" href="mailto:?subject=[À MODIFIER - objet du mail]&amp;body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]"&gt;
                Partager par email
            &lt;/a&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;button class="fr-btn--copy fr-btn" id="share-6753" onclick="navigator.clipboard.writeText(window.location).then(function() {alert('Adresse copiée dans le presse papier.')});"&gt;
                Copier dans le presse-papier
            &lt;/button&gt;
        &lt;/li&gt;
    &lt;/ul&gt;
&lt;/div&gt;
                    ...
                    <h3>Boutons de partage par défaut</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-share">
                            <p class="fr-share__title">Partager la page</p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6755">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-6755">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6756">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-6756">
                                <pre class=" language-html"><code>&lt;div class="fr-share"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;p class="fr-share__text"&gt;Veuillez &lt;a href=[À MODIFIER - url page autorisation cookies]&gt;autoriser le dépôt de cookies&lt;/a&gt; pour partager sur Facebook, Twitter et LinkedIn.&lt;/p&gt;
    &lt;ul class="fr-share__group"&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-6757">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-6758" title="Fermer">
                                Fermer
                            </button>
                        </div>
