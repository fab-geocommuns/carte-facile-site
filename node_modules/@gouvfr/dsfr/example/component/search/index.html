...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Barre de recherche (search)</h1>
        <p>La barre de recherche est un système de navigation qui permet à l'utilisateur d’accéder rapidement à un contenu en lançant une recherche sur un mot clé ou une expression.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/barre-de-recherche" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Barre de recherche MD (par défaut)</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar" id="search-1281" role="search">
                            <label class="fr-label" for="search-1281-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-1281-input-messages" placeholder="Rechercher" id="search-1281-input" type="search">
                            <div class="fr-messages-group" id="search-1281-input-messages" aria-live="polite">
                            </div>
                            <button class="fr-btn" id="search-btn-1282" title="Rechercher">
                                Rechercher
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1285">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1285">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar" id="search-1283" role="search"&gt;
    &lt;label class="fr-label" for="search-1283-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="search-1283-input-messages" placeholder="Rechercher" id="search-1283-input" type="search"&gt;
    &lt;div class="fr-messages-group" id="search-1283-input-messages" aria-live="polite"&gt;
    &lt;/div&gt;
    &lt;button class="fr-btn" id="search-btn-1284" title="Rechercher"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <h3>Barre de recherche LG</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-search-bar fr-search-bar--lg" id="search-1286" role="search">
                            <label class="fr-label" for="search-1286-input">
                                Rechercher
                            </label>
                            <input class="fr-input" aria-describedby="search-1286-input-messages" placeholder="Rechercher" id="search-1286-input" type="search">
                            <div class="fr-messages-group" id="search-1286-input-messages" aria-live="polite">
                            </div>
                            <button class="fr-btn" id="search-btn-1287">
                                Rechercher
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div class="fr-collapse" id="snippet-1290">
                                <pre class=" language-html"><code>&lt;div class="fr-search-bar fr-search-bar--lg" id="search-1288" role="search"&gt;
    &lt;label class="fr-label" for="search-1288-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="search-1288-input-messages" placeholder="Rechercher" id="search-1288-input" type="search"&gt;
    &lt;div class="fr-messages-group" id="search-1288-input-messages" aria-live="polite"&gt;
    &lt;/div&gt;
    &lt;button class="fr-btn" id="search-btn-1289"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-1291">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-1292" title="Fermer">
                                Fermer
                            </button>
                        </div>
