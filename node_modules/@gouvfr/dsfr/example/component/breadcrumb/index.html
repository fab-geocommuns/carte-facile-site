...
<body id="top" class="fr-mb-12w">
        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Fil d’Ariane avec liens</h3>
                    <div class="fr-mb-6v">
                        <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                            <button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-3882">Voir le fil d’Ariane</button>
                            <div class="fr-collapse" id="breadcrumb-3882">
                                <ol class="fr-breadcrumb__list">
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3874" href="../">Accueil</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3875" href="../">Segment 1: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3876" href="../">Segment 2: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3877" href="../">Segment 3: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3878" href="../">Segment 4: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3879" href="../">Segment 5: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3880" href="../">Segment 6: lorem ipsum</a>
                                    </li>
                                    <li>
                                        <a class="fr-breadcrumb__link" id="breadcrumb-3881" href="../">Segment 7: lorem ipsum</a>
                                    </li>
                                    <li>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3892">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3892">
    ...
    &lt;div class="fr-collapse" id="breadcrumb-3891"&gt;
        &lt;ol class="fr-breadcrumb__list"&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3883" href="../"&gt;Accueil&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3884" href="../"&gt;Segment 1: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3885" href="../"&gt;Segment 2: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3886" href="../"&gt;Segment 3: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3887" href="../"&gt;Segment 4: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3888" href="../"&gt;Segment 5: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3889" href="../"&gt;Segment 6: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" id="breadcrumb-3890" href="../"&gt;Segment 7: lorem ipsum&lt;/a&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" aria-current="page"&gt;Page Actuelle&lt;/a&gt;
            &lt;/li&gt;
...
&lt;/nav&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-3893">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-3894" title="Fermer">
                                Fermer
                            </button>
                        </div>
