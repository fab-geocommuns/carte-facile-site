...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Fil d&#39;Ariane (breadcrumb)</h1>
        <p>Le fil d’Ariane est un système de navigation secondaire qui permet à l’utilisateur de se situer sur le site qu’il consulte.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/fil-d-ariane" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Fil d’Ariane avec boutons</h3>
                    <div class="fr-mb-6v">
                        <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                            <button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-3903">Voir le fil d’Ariane</button>
                            <div class="fr-collapse" id="breadcrumb-3903">
                                <ol class="fr-breadcrumb__list">
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3895">Accueil</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3896">Segment 1: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3897">Segment 2: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3898">Segment 3: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3899">Segment 4: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3900">Segment 5: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3901">Segment 6: lorem ipsum</button>
                                    </li>
                                    <li>
                                        <button class="fr-breadcrumb__link" id="breadcrumb-3902">Segment 7: lorem ipsum</button>
                                    </li>
                                    <li>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3913">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3913">
                                <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :"&gt;
    &lt;button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-3912"&gt;Voir le fil d’Ariane&lt;/button&gt;
    &lt;div class="fr-collapse" id="breadcrumb-3912"&gt;
        &lt;ol class="fr-breadcrumb__list"&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3904"&gt;Accueil&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3905"&gt;Segment 1: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3906"&gt;Segment 2: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3907"&gt;Segment 3: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3908"&gt;Segment 4: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3909"&gt;Segment 5: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3910"&gt;Segment 6: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;button class="fr-breadcrumb__link" id="breadcrumb-3911"&gt;Segment 7: lorem ipsum&lt;/button&gt;
            &lt;/li&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" aria-current="page"&gt;Page Actuelle&lt;/a&gt;
            &lt;/li&gt;
...
&lt;/nav&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-3914">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-3915" title="Fermer">
                                Fermer
                            </button>
                        </div>
