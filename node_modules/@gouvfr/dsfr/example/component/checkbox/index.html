...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Case à cocher (checkbox)</h1>
        <p>La case à cocher permet à l’utilisateur de sélectionner une ou plusieurs options dans une liste. Elle est utilisée pour effectuer des sélections multiples (de 0 à N éléments), ou bien pour permettre un choix binaire, lorsque l’utilisateur peut sélectionner ou désélectionner une seule option.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/case-a-cocher" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Case à cocher seule</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1978">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1978">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox" type="checkbox" aria-describedby="checkbox-messages"&gt;
    &lt;label class="fr-label" for="checkbox"&gt;
        Label checkbox
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Case à cocher seule, exemple avec indice et exposant</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-checkbox-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1979">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1979">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox-sup-sub" type="checkbox" aria-describedby="checkbox-sup-sub-messages"&gt;
    &lt;label class="fr-label" for="checkbox-sup-sub"&gt;
        &lt;span&gt;Label checkbox &lt;sub&gt;sub&lt;/sub&gt; et &lt;sup&gt;sup&lt;/sup&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Case à cocher avec texte d‘aide</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-checkbox-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1980">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1980">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input id="checkbox-hint" type="checkbox" aria-describedby="checkbox-hint-messages"&gt;
    &lt;label class="fr-label" for="checkbox-hint"&gt;
        Label checkbox
...
&lt;/div&gt;
                    ...
                    <h3>Case à cocher seule, validée</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1981">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1981">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group fr-checkbox-group--valid"&gt;
    &lt;input aria-describedby="checkbox-valid-messages" id="checkbox-valid" type="checkbox"&gt;
    &lt;label class="fr-label" for="checkbox-valid"&gt;
        Label checkbox
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Case à cocher seule avec erreur</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1982">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1982">
                                <pre class=" language-html"><code>&lt;div class="fr-checkbox-group fr-checkbox-group--error"&gt;
    &lt;input aria-describedby="checkbox-error-messages" id="checkbox-error" type="checkbox"&gt;
    &lt;label class="fr-label" for="checkbox-error"&gt;
        Label checkbox
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1983">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1983">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes" aria-labelledby="checkboxes-legend checkboxes-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher, petite taille</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1984">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1984">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes-small" aria-labelledby="checkboxes-small-legend checkboxes-small-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-small-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher désactivées</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1985">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1985">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes-disabled" aria-labelledby="checkboxes-disabled-legend checkboxes-disabled-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-disabled-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1986">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1986">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes-inline" aria-labelledby="checkboxes-inline-legend checkboxes-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher avec texte d‘aide</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1987">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1987">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes-hint" aria-labelledby="checkboxes-hint-legend checkboxes-hint-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-hint-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1988">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1988">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="checkboxes-error" role="group" aria-labelledby="checkboxes-error-legend checkboxes-error-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-error-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher validées</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1989">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1989">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--valid" id="checkboxes-valid" role="group" aria-labelledby="checkboxes-valid-legend checkboxes-valid-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-valid-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher avec erreur, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1990">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1990">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="checkboxes-error-inline" role="group" aria-labelledby="checkboxes-error-inline-legend checkboxes-error-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-error-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher validées, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1991">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1991">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--valid" id="checkboxes-valid-inline" role="group" aria-labelledby="checkboxes-valid-inline-legend checkboxes-valid-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-valid-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher avec texte d‘aide spécifique</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1992">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1992">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes-hint-element" aria-labelledby="checkboxes-hint-element-legend checkboxes-hint-element-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-hint-element-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de cases à cocher avec texte d‘aide spécifique, petite taille</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1993">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1993">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkboxes-hint-el-sm" aria-labelledby="checkboxes-hint-el-sm-legend checkboxes-hint-el-sm-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkboxes-hint-el-sm-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-1994">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-1995" title="Fermer">
                                Fermer
                            </button>
                        </div>
