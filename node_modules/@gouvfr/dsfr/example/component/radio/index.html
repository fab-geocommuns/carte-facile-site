...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bouton radio (radio)</h1>
        <p>Le bouton radio permettent à l’utilisateur de sélectionner une seule option dans une liste.</p>
        <h5>Documentation</h5>
        <ul>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/bouton-radio" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre"> Bouton radio</a>
            </li>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/bouton-radio-riche" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre"> Bouton radio riche</a>
            </li>
        </ul>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <div class="fr-mt-0">
                        <h2>Bouton radio simple</h2>
                    </div>
                    <h3>Ensemble de boutons radio</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1462">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1462">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio" aria-labelledby="radio-legend radio-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio, petite taille</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1463">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1463">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-small" aria-labelledby="radio-small-legend radio-small-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-small-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio désactivées</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1464">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1464">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-disabled" aria-labelledby="radio-disabled-legend radio-disabled-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-disabled-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1465">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1465">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-inline" aria-labelledby="radio-inline-legend radio-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio avec texte d‘aide</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1466">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1466">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-hint" aria-labelledby="radio-hint-legend radio-hint-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-hint-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio avec erreur</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1467">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1467">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="radio-error" role="group" aria-labelledby="radio-error-legend radio-error-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-error-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio avec erreur, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1468">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1468">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="radio-error-inline" role="group" aria-labelledby="radio-error-inline-legend radio-error-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-error-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio validés</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1469">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1469">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--valid" id="radio-valid" role="group" aria-labelledby="radio-valid-legend radio-valid-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-valid-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio validés, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1470">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1470">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--valid" id="radio-valid-inline" role="group" aria-labelledby="radio-valid-inline-legend radio-valid-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-valid-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio avec texte d‘aide spécifique</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1471">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1471">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-hint-element" aria-labelledby="radio-hint-element-legend radio-hint-element-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-hint-element-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio avec texte d‘aide spécifique, petite taille</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1472">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1472">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-hint-el-sm" aria-labelledby="radio-hint-el-sm-legend radio-hint-el-sm-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-hint-el-sm-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio, libellé en indice et exposant</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1473">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1473">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-sub" aria-labelledby="radio-sub-legend radio-sub-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-sub-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mt-32v">
                        <h2>Bouton radio riche</h2>
                    </div>
                    <h3>Ensemble de boutons radio riches, simple</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1474">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1474">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich" aria-labelledby="radio-rich-legend radio-rich-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches, en ligne, simple</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1475">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1475">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich-inline" aria-labelledby="radio-rich-inline-legend radio-rich-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches sans pictogramme</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1476">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1476">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich-no-img" aria-labelledby="radio-rich-no-img-legend radio-rich-no-img-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-no-img-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1477">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1477">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich-no-pictogram-inline" aria-labelledby="radio-rich-no-pictogram-inline-legend radio-rich-no-pictogram-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-no-pictogram-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches avec textes d&#39;aide</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1478">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1478">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich-hint" aria-labelledby="radio-rich-hint-legend radio-rich-hint-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-hint-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches avec textes d&#39;aide, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1479">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1479">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich-hint-inline" aria-labelledby="radio-rich-hint-inline-legend radio-rich-hint-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-hint-inline-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches avec erreur et textes d&#39;aide</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1480">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1480">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="radio-rich-error" role="group" aria-labelledby="radio-rich-error-legend radio-rich-error-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-error-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches avec erreur et textes d&#39;aide, en ligne</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1481">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1481">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="radio-rich-error-inline" role="group" aria-labelledby="radio-rich-error-inline-legend radio-rich-error-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-error-inline-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Ensemble de boutons radio riches désactivés</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1482">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1482">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-rich-disabled" aria-labelledby="radio-rich-disabled-legend radio-rich-disabled-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-rich-disabled-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-1483">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-1484" title="Fermer">
                                Fermer
                            </button>
                        </div>
