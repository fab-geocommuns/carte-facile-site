...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bloc marque (logo)</h1>
        <p>Bloc marque de l'état</p>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Logo MD (par défaut)</h3>
                    <div class="fr-mb-6v">
                        <p class="fr-logo">
                            Intitulé
                            <br>officiel
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1293">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1293">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Intitulé
    &lt;br&gt;officiel
&lt;/p&gt;
</code></pre>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1294">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1294">
                                <pre class=" language-html"><code>&lt;p class="fr-logo fr-logo--sm"&gt;
    Intitulé
    &lt;br&gt;officiel
&lt;/p&gt;
</code></pre>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1295">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1295">
                                <pre class=" language-html"><code>&lt;p class="fr-logo fr-logo--lg"&gt;
    Intitulé
    &lt;br&gt;officiel
&lt;/p&gt;
</code></pre>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1296">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1296">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de la transition
    &lt;br&gt;écologique
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1297">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1297">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Secrétaire d’État
    &lt;br&gt;chargé(e) de
    &lt;br&gt;l’égalité entre les
...
&lt;/p&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1298">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1298">
                                <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de l’europe
    &lt;br&gt;et des affaires
...
&lt;/p&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-1299">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-1300" title="Fermer">
                                Fermer
                            </button>
                        </div>
