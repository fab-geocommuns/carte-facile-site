...
<head>
    ...
    <title>Gestionnaire de consentement - Système de design</title>
    ...
    <link href="../../../dist/component/consent/consent.main.css" rel="stylesheet">
    ...
    <link href="../../../dist/component/consent/consent.legacy.css" rel="stylesheet">
    ...
    <link href="../../../dist/component/consent/consent.print.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Gestionnaire de consentement (consent)</h1>
        <p>Le gestionnaire de consentement permet à l'utilisateur de définir ses préférences sur l'utilisation de ses données personnelles.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/gestionnaire-de-consentement" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-consent-banner">
                            ...
                            <ul class="fr-consent-banner__buttons fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-sm">
                                <li>
                                    <button class="fr-btn" id="button-3972" title="Autoriser tous les cookies">
                                        Tout accepter
                                    </button>
                                </li>
                                <li>
                                    <button class="fr-btn" id="button-3973" title="Refuser tous les cookies">
                                        Tout refuser
                                    </button>
                                </li>
                                <li>
                                    <button class="fr-btn fr-btn--secondary" data-fr-opened="false" aria-controls="fr-consent-modal" id="button-3974" title="Personnaliser les cookies">
                                        Personnaliser
                                    </button>
                                </li>
                            </ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3978">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3978">
                                <pre class=" language-html"><code>&lt;div class="fr-consent-banner"&gt;
    &lt;h2 class="fr-h6"&gt;À propos des cookies sur nomdusite.fr&lt;/h2&gt;
    &lt;div class="fr-consent-banner__content"&gt;
        &lt;p class="fr-text--sm"&gt;Bienvenue ! Nous utilisons des cookies pour améliorer votre expérience et les services disponibles sur ce site. Pour en savoir plus, visitez la page &lt;a href=""&gt;Données personnelles et cookies&lt;/a&gt;. Vous pouvez, à tout moment, avoir le contrôle sur les cookies que vous souhaitez activer.&lt;/p&gt;
    &lt;/div&gt;
    &lt;ul class="fr-consent-banner__buttons fr-btns-group fr-btns-group--right fr-btns-group--inline-reverse fr-btns-group--inline-sm"&gt;
        &lt;li&gt;
            &lt;button class="fr-btn" id="button-3975" title="Autoriser tous les cookies"&gt;
                Tout accepter
            &lt;/button&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;button class="fr-btn" id="button-3976" title="Refuser tous les cookies"&gt;
                Tout refuser
            &lt;/button&gt;
        &lt;/li&gt;
        &lt;li&gt;
            &lt;button class="fr-btn fr-btn--secondary" data-fr-opened="false" aria-controls="fr-consent-modal" id="button-3977" title="Personnaliser les cookies"&gt;
                Personnaliser
            &lt;/button&gt;
        &lt;/li&gt;
    &lt;/ul&gt;
&lt;/div&gt;
                                    ...
                                    <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                        <div class="fr-modal__body">
                                            <div class="fr-modal__header">
                                                <button class="fr-btn--close fr-btn" aria-controls="fr-consent-modal" id="button-3980" title="Fermer">
                                                    Fermer
                                                </button>
                                            </div>
                                            <div class="fr-modal__content">
                                                ...
                                                <div class="fr-consent-manager">
                                                    ...
                                                    <ul class="fr-consent-manager__buttons fr-btns-group fr-btns-group--right fr-btns-group--inline-sm">
                                                        <li>
                                                            <button class="fr-btn" id="button-3979">
                                                                Confirmer mes choix
                                                            </button>
                                                        </li>
                                                    </ul>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3983">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3983">
                                <pre class=" language-html"><code>&lt;dialog id="fr-consent-modal" class="fr-modal" aria-labelledby="fr-consent-modal-title"&gt;
    &lt;div class="fr-container fr-container--fluid fr-container-md"&gt;
        &lt;div class="fr-grid-row fr-grid-row--center"&gt;
            &lt;div class="fr-col-12 fr-col-md-10 fr-col-lg-8"&gt;
                &lt;div class="fr-modal__body"&gt;
                    &lt;div class="fr-modal__header"&gt;
                        &lt;button class="fr-btn--close fr-btn" aria-controls="fr-consent-modal" id="button-3982" title="Fermer"&gt;
                            Fermer
                        &lt;/button&gt;
                    &lt;/div&gt;
                    &lt;div class="fr-modal__content"&gt;
                        ...
                        &lt;div class="fr-consent-manager"&gt;
                            ...
                            &lt;ul class="fr-consent-manager__buttons fr-btns-group fr-btns-group--right fr-btns-group--inline-sm"&gt;
                                &lt;li&gt;
                                    &lt;button class="fr-btn" id="button-3981"&gt;
                                        Confirmer mes choix
                                    &lt;/button&gt;
                                &lt;/li&gt;
                            &lt;/ul&gt;
...
&lt;/dialog&gt;
                    ...
                    <h3>Placeholder cookies désactivés standard</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-consent-placeholder">
                            ...
                            <button class="fr-btn" id="button-3984" title="Autorisez le dépôt de cookies pour accéder au service **Nom du service**">
                                Autoriser
                            </button>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3986">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-3986">
                                <pre class=" language-html"><code>&lt;div class="fr-consent-placeholder"&gt;
    &lt;h4 class="fr-h6"&gt;**Nom du service** est désactivé&lt;/h4&gt;
    &lt;p&gt;Autorisez le dépôt de cookies pour accéder à cette fonctionnalité.&lt;/p&gt;
    &lt;button class="fr-btn" id="button-3985" title="Autorisez le dépôt de cookies pour accéder au service **Nom du service**"&gt;
        Autoriser
    &lt;/button&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <h3>Placeholder dans un bloc vidéo responsive grande taille</h3>
                    <div class="fr-mb-6v">
                        <figure role="group" class="fr-content-media fr-content-media--lg" id="media-3988">
                            <div class="fr-responsive-vid">
                                <div class="fr-consent-placeholder">
                                    <h4 class="fr-h6">**Nom du service** est désactivé</h4>
                                    <p>Autorisez le dépôt de cookies pour accèder à cette fonctionnalité.</p>
                                    <button class="fr-btn" id="button-3989">
                                        Autoriser
                                    </button>
                                </div>
                            </div>
                            <figcaption class="fr-content-media__caption">
                                Description / Source
                                <a class="fr-link" id="link-3990" href="[url - à modifier]">Label lien</a>
                            </figcaption>
                            <div class="fr-transcription" id="transcription-3987">
                                <button class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-3987">Transcription</button>
                                <div class="fr-collapse" id="fr-transcription-collapse-transcription-3987">
                                    <div class="fr-transcription__footer">
                                        <div class="fr-transcription__actions-group">
                                            <button class="fr-btn--fullscreen fr-btn" aria-controls="fr-transcription-modal-transcription-3987" data-fr-opened="false" id="button-3992">
                                            </button>
                                        </div>
                                    </div>
                                    <div id="fr-transcription-modal-transcription-3987" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-3987-title">
                                        <div class="fr-container fr-container--fluid fr-container-md">
                                            <div class="fr-grid-row fr-grid-row--center">
                                                <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                    <div class="fr-modal__body">
                                                        <div class="fr-modal__header">
                                                            <button class="fr-btn--close fr-btn" aria-controls="fr-transcription-modal-transcription-3987" id="button-3993" title="Fermer">
                                                                Fermer
                                                            </button>
                                                        </div>
                                                        <div class="fr-modal__content">
                                                            <h1 id="fr-transcription-modal-transcription-3987-title" class="fr-modal__title">
                                                                Titre de la vidéo
                                                            </h1>
                                                            <!-- données de test -->
                                                            <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4000">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4000">
                                <pre class=" language-html"><code>&lt;figure role="group" class="fr-content-media fr-content-media--lg" id="media-3994"&gt;
    &lt;div class="fr-responsive-vid"&gt;
        &lt;div class="fr-consent-placeholder"&gt;
            &lt;h4 class="fr-h6"&gt;**Nom du service** est désactivé&lt;/h4&gt;
            &lt;p&gt;Autorisez le dépôt de cookies pour accèder à cette fonctionnalité.&lt;/p&gt;
            &lt;button class="fr-btn" id="button-3995"&gt;
                Autoriser
            &lt;/button&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;figcaption class="fr-content-media__caption"&gt;
        Description / Source
        &lt;a class="fr-link" id="link-3996" href="[url - à modifier]"&gt;Label lien&lt;/a&gt;
    &lt;/figcaption&gt;
    &lt;div class="fr-transcription" id="transcription-3987"&gt;
        &lt;button class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-3987"&gt;Transcription&lt;/button&gt;
        &lt;div class="fr-collapse" id="fr-transcription-collapse-transcription-3987"&gt;
            &lt;div class="fr-transcription__footer"&gt;
                &lt;div class="fr-transcription__actions-group"&gt;
                    &lt;button class="fr-btn--fullscreen fr-btn" aria-controls="fr-transcription-modal-transcription-3987" data-fr-opened="false" id="button-3998"&gt;
                    &lt;/button&gt;
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div id="fr-transcription-modal-transcription-3987" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-3987-title"&gt;
                &lt;div class="fr-container fr-container--fluid fr-container-md"&gt;
                    &lt;div class="fr-grid-row fr-grid-row--center"&gt;
                        &lt;div class="fr-col-12 fr-col-md-10 fr-col-lg-8"&gt;
                            &lt;div class="fr-modal__body"&gt;
                                &lt;div class="fr-modal__header"&gt;
                                    &lt;button class="fr-btn--close fr-btn" aria-controls="fr-transcription-modal-transcription-3987" id="button-3999" title="Fermer"&gt;
                                        Fermer
                                    &lt;/button&gt;
                                &lt;/div&gt;
                                &lt;div class="fr-modal__content"&gt;
...
&lt;/figure&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-4001">
        Label bouton
    </button>
        ...
        <div class="fr-container fr-container--fluid fr-container-md">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-4002" title="Fermer">
                                Fermer
                            </button>
                        </div>
                        <div class="fr-modal__content">
