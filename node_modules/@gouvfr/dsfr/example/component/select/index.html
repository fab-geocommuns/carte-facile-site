...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Liste déroulante (select)</h1>
        <p>La liste déroulante permet à un utilisateur de choisir un élément dans une liste donnée.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/liste-deroulante" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Liste déroulante par défaut</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4621">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4621">
                                <pre class=" language-html"><code>&lt;div class="fr-select-group"&gt;
    &lt;label class="fr-label" for="select"&gt;
        Label pour liste déroulante
    &lt;/label&gt;
    &lt;select class="fr-select" aria-describedby="select-messages" id="select" name="select"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Liste déroulante désactivée</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4622">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4622">
                                <pre class=" language-html"><code>&lt;div class="fr-select-group fr-select-group--disabled"&gt;
    &lt;label class="fr-label" for="select-disabled"&gt;
        Label pour liste déroulante
    &lt;/label&gt;
    &lt;select class="fr-select" aria-describedby="select-disabled-messages" disabled id="select-disabled" name="select-disabled"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Liste déroulante avec texte de description</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-select-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4623">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4623">
                                <pre class=" language-html"><code>&lt;div class="fr-select-group"&gt;
    &lt;label class="fr-label" for="select-hint"&gt;
        Label pour liste déroulante
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4624">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4624">
                                <pre class=" language-html"><code>&lt;div class="fr-select-group fr-select-group--valid"&gt;
    &lt;label class="fr-label" for="select-valid"&gt;
        Label pour liste déroulante
    &lt;/label&gt;
    &lt;select class="fr-select" aria-describedby="select-valid-messages" id="select-valid" name="select-valid"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4625">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4625">
                                <pre class=" language-html"><code>&lt;div class="fr-select-group fr-select-group--error"&gt;
    &lt;label class="fr-label" for="select-error"&gt;
        Label pour liste déroulante
    &lt;/label&gt;
    &lt;select class="fr-select" aria-describedby="select-error-messages" id="select-error" name="select-error"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Liste déroulante avec groupe d&#39;options</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-select-group">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4626">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-4626">
                                <pre class=" language-html"><code>&lt;div class="fr-select-group"&gt;
    &lt;label class="fr-label" for="select-group"&gt;
        Label pour liste déroulante
    &lt;/label&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-4627">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-4628" title="Fermer">
                                Fermer
                            </button>
                        </div>
