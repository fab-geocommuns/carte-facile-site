...
<head>
    ...
    <title>Bloc fonctionnel de numéro de téléphone - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Bloc fonctionnel de numéro de téléphone (input-tel)</h1>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/blocs-fonctionnels/numero-de-telephone" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Demande d&#39;un numéro de téléphone</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7655">
                            <label class="fr-label" for="tel-7654">
                                Numéro de téléphone
                                <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                            </label>
                            <input class="fr-input" autocomplete="tel" aria-describedby="tel-7654-messages" id="tel-7654" type="tel">
                            <div class="fr-messages-group" id="tel-7654-messages" aria-live="polite">
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7658">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7658">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7657"&gt;
    &lt;label class="fr-label" for="tel-7656"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7656-messages" id="tel-7656" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7656-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                            </div>
                    ...
                    <h3>Demande d&#39;un numéro de téléphone - Erreur</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error" id="input-group-7660">
                            <label class="fr-label" for="tel-7659">
                                Numéro de téléphone
                                <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                            </label>
                            <input class="fr-input" autocomplete="tel" aria-describedby="tel-7659-messages" id="tel-7659" type="tel">
                            <div class="fr-messages-group" id="tel-7659-messages" aria-live="polite">
                                <p class="fr-message fr-message--error" id="tel-7659-message-error">Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 2 43 55 55 55</p>
                            </div>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7663">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7663">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-7662"&gt;
    &lt;label class="fr-label" for="tel-7661"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7661-messages" id="tel-7661" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7661-messages" aria-live="polite"&gt;
        &lt;p class="fr-message fr-message--error" id="tel-7661-message-error"&gt;Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 2 43 55 55 55&lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                            </div>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7664">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7665" title="Fermer">
                                Fermer
                            </button>
                        </div>
