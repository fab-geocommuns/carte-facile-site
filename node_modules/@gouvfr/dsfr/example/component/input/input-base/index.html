...
<head>
    ...
    <link href="../../../../dist/component/input/input-base/input-base.main.css" rel="stylesheet">
    ...
    <link href="../../../../dist/component/input/input-base/input-base.legacy.css" rel="stylesheet">
    ...
    <link href="../../../../dist/component/input/input-base/input-base.print.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Champ de saisie (input-base)</h1>
        <p>Les champs permettent à un utilisateur d'entrer du contenu et données.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/blocs-fonctionnels/adresse-electronique" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Champ de type &#34;text&#34;</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7668">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7668">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7667"&gt;
    &lt;label class="fr-label" for="text-input-text"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-text-messages" id="text-input-text" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ de type &#34;number&#34;</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7669">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7671">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7671">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7670"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" pattern="[0-9]*" inputmode="numeric" aria-describedby="text-input-number-messages" id="text-input-number" type="number"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ de type &#34;search&#34;</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7672">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7674">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7674">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7673"&gt;
    &lt;label class="fr-label" for="text-input-search"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-search-messages" id="text-input-search" type="search"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ de type &#34;date&#34;</h3>
                    <p class="fr-text--sm fr-text-mention-grey">Préférez l'utilisation du modèle de bloc de <a href="../../../pattern/date/">Date unique</a>
                    </p>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7677">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7677">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7676"&gt;
    &lt;label class="fr-label" for="text-input-date"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-date-messages" id="text-input-date" type="date"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ de type &#34;textarea&#34;</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7678">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7680">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7680">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7679"&gt;
    &lt;label class="fr-label" for="textarea"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;textarea class="fr-input" aria-describedby="textarea-messages" id="textarea"&gt;&lt;/textarea&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ de type &#34;password&#34;</h3>
                    <p class="fr-text--sm fr-text-mention-grey">Préférez l'utilisation du composant <a href="../../password/">Mot de passe</a>
                    </p>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7681">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7683">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7683">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7682"&gt;
    &lt;label class="fr-label" for="text-input-password"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-password-messages" id="text-input-password" type="password"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Combo champ + bouton d&#39;envoi</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7684">
                            ...
                            <div class="fr-input-wrap fr-input-wrap--addon">
                                ...
                                <button class="fr-btn" id="button-7685" type="submit">
                                    Envoyer
                                </button>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7688">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7688">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7686"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--addon"&gt;
        &lt;input class="fr-input" aria-describedby="text-input-button-messages" id="text-input-button" type="text"&gt;
        &lt;button class="fr-btn" id="button-7687" type="submit"&gt;
            Envoyer
        &lt;/button&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="text-input-button-messages" aria-live="polite"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Combo champ + bouton d&#39;action</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7689">
                            ...
                            <div class="fr-input-wrap fr-input-wrap--action">
                                ...
                                <button class="fr-btn fr-icon-delete-line fr-btn--secondary" id="button-7690" type="button">
                                    Supprimer le champ
                                </button>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7693">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7693">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7691"&gt;
    &lt;label class="fr-label" for="text-input-action"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--action"&gt;
        &lt;input class="fr-input" aria-describedby="text-input-action-messages" id="text-input-action" type="text"&gt;
        &lt;button class="fr-btn fr-icon-delete-line fr-btn--secondary" id="button-7692" type="button"&gt;
            Supprimer le champ
        &lt;/button&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="text-input-action-messages" aria-live="polite"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ avec placeholder</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7694">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7696">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7696">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7695"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-placeholder-messages" placeholder="placeholder" id="text-input-placeholder" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ avec valeur initiale</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7697">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7699">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7699">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7698"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" value="value" aria-describedby="text-input-value-messages" id="text-input-value" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ avec icône personalisée</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7700">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7702">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7702">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7701"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ désactivé</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--disabled" id="input-group-7703">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7705">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7705">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--disabled" id="input-group-7704"&gt;
    &lt;label class="fr-label" for="text-input-disabled"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-disabled-messages" disabled id="text-input-disabled" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ avec texte additionnel</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7708">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7708">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7707"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ valide avec texte de succès</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--valid" id="input-group-7709">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7711">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7711">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid" id="input-group-7710"&gt;
    &lt;label class="fr-label" for="text-input-valid"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-valid-messages" id="text-input-valid" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Champ en erreur avec texte d&#39;erreur</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error" id="input-group-7712">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7714">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7714">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-7713"&gt;
    &lt;label class="fr-label" for="text-input-error"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-error-messages" id="text-input-error" type="text"&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7715">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7716" title="Fermer">
                                Fermer
                            </button>
                        </div>
