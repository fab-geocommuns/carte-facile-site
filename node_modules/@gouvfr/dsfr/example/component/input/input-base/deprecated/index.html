                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7717">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7717">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-text"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" id="text-input-text" type="text"&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7718">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7718">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7719">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7719">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-search"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7720">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7720">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-date"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7721">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7721">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="textarea"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7722">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7722">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-password"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group">
                            ...
                            <div class="fr-input-wrap fr-input-wrap--addon">
                                ...
                                <button class="fr-btn" id="button-7723" type="submit">
                                    Envoyer
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7725">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7725">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;
        Label champ de saisie
    &lt;/label&gt;
    &lt;div class="fr-input-wrap fr-input-wrap--addon"&gt;
        &lt;input class="fr-input" id="text-input-button" type="text"&gt;
        &lt;button class="fr-btn" id="button-7724" type="submit"&gt;
            Envoyer
        &lt;/button&gt;
    &lt;/div&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7726">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7726">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7727">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7727">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7728">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7728">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7729">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7729">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--disabled"&gt;
    &lt;label class="fr-label" for="text-input-disabled"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" disabled id="text-input-disabled" type="text"&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7730">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7730">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7731">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7731">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid"&gt;
    &lt;label class="fr-label" for="text-input-valid"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input fr-input--valid" aria-describedby="text-input-valid-desc-valid" id="text-input-valid" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7732">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7732">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-error"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input fr-input--error" aria-describedby="text-input-error-desc-error" id="text-input-error" type="text"&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7733">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7734" title="Fermer">
                                Fermer
                            </button>
                        </div>
