...
<head>
    ...
    <link href="../../../dist/component/segmented/segmented.legacy.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Contrôle segmenté (segmented)</h1>
        <p>Le composant "contrôle segmenté" incite l'utilisateur à choisir entre plusieurs options d'affichage disponibles (vues), mutuellement exclusives avec une valeur sélectionnée par défaut.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/controle-segmente" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Contrôle segmenté simple</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented">
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2214-1" name="segmented-2214">
                                    <label class="fr-label" for="segmented-2214-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2214-2" name="segmented-2214">
                                    <label class="fr-label" for="segmented-2214-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" type="radio" id="segmented-2214-3" name="segmented-2214">
                                    <label class="fr-label" for="segmented-2214-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2216">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2216">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented"&gt;
    &lt;legend class="fr-segmented__legend"&gt;
        Légende
    &lt;/legend&gt;
    &lt;div class="fr-segmented__elements"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Contrôle segmenté taille SM</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented fr-segmented--sm">
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2217-1" name="segmented-2217">
                                    <label class="fr-label" for="segmented-2217-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2217-2" name="segmented-2217">
                                    <label class="fr-label" for="segmented-2217-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" type="radio" id="segmented-2217-3" name="segmented-2217">
                                    <label class="fr-label" for="segmented-2217-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2219">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2219">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented fr-segmented--sm"&gt;
    &lt;legend class="fr-segmented__legend"&gt;
        Légende
    &lt;/legend&gt;
    &lt;div class="fr-segmented__elements"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Contrôle segmenté avec légende en ligne</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented">
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2220-1" name="segmented-2220">
                                    <label class="fr-label" for="segmented-2220-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2220-2" name="segmented-2220">
                                    <label class="fr-label" for="segmented-2220-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" type="radio" id="segmented-2220-3" name="segmented-2220">
                                    <label class="fr-label" for="segmented-2220-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2222">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2222">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented"&gt;
    &lt;legend class="fr-segmented__legend fr-segmented__legend--inline"&gt;
        Légende
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Contrôle segmenté avec texte d&#39;aide</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented">
                            <legend class="fr-segmented__legend">
                                Légende
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2223-1" name="segmented-2223">
                                    <label class="fr-label" for="segmented-2223-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2223-2" name="segmented-2223">
                                    <label class="fr-label" for="segmented-2223-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" type="radio" id="segmented-2223-3" name="segmented-2223">
                                    <label class="fr-label" for="segmented-2223-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2225">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2225">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented"&gt;
    &lt;legend class="fr-segmented__legend"&gt;
        Légende
        &lt;span class="fr-hint-text"&gt;texte additionel&lt;/span&gt;
    ...
    &lt;div class="fr-segmented__elements"&gt;
        &lt;div class="fr-segmented__element"&gt;
            &lt;input value="1" type="radio" id="segmented-2224-1" name="segmented-2224"&gt;
            &lt;label class="fr-label" for="segmented-2224-1"&gt;
                Libellé
            &lt;/label&gt;
        &lt;/div&gt;
        &lt;div class="fr-segmented__element"&gt;
            &lt;input value="2" checked type="radio" id="segmented-2224-2" name="segmented-2224"&gt;
            &lt;label class="fr-label" for="segmented-2224-2"&gt;
                Libellé
            &lt;/label&gt;
        &lt;/div&gt;
        &lt;div class="fr-segmented__element"&gt;
            &lt;input value="3" type="radio" id="segmented-2224-3" name="segmented-2224"&gt;
            &lt;label class="fr-label" for="segmented-2224-3"&gt;
                Libellé
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
                    ...
                    <h3>Contrôle segmenté avec icônes</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented">
                            <legend class="fr-segmented__legend">
                                Légende
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2226-1" name="segmented-2226">
                                    <label class="fr-icon-road-map-line fr-label" for="segmented-2226-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2226-2" name="segmented-2226">
                                    <label class="fr-icon-road-map-line fr-label" for="segmented-2226-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" type="radio" id="segmented-2226-3" name="segmented-2226">
                                    <label class="fr-icon-road-map-line fr-label" for="segmented-2226-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2228">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2228">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented"&gt;
    &lt;legend class="fr-segmented__legend"&gt;
        Légende
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Contrôle segmenté sans légende</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented fr-segmented--no-legend">
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2229-1" name="segmented-2229">
                                    <label class="fr-label" for="segmented-2229-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2229-2" name="segmented-2229">
                                    <label class="fr-label" for="segmented-2229-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" type="radio" id="segmented-2229-3" name="segmented-2229">
                                    <label class="fr-label" for="segmented-2229-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2231">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2231">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented fr-segmented--no-legend"&gt;
    &lt;legend class="fr-segmented__legend"&gt;
        Légende
    &lt;/legend&gt;
    &lt;div class="fr-segmented__elements"&gt;
...
&lt;/fieldset&gt;
                    ...
                    <h3>Contrôle segmenté désactivé</h3>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented">
                            <legend class="fr-segmented__legend">
                                Légende
                            ...
                            <div class="fr-segmented__elements">
                                <div class="fr-segmented__element">
                                    <input value="1" type="radio" id="segmented-2232-1" name="segmented-2232">
                                    <label class="fr-label" for="segmented-2232-1">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="2" checked type="radio" id="segmented-2232-2" name="segmented-2232">
                                    <label class="fr-label" for="segmented-2232-2">
                                        Libellé
                                    </label>
                                </div>
                                <div class="fr-segmented__element">
                                    <input value="3" disabled type="radio" id="segmented-2232-3" name="segmented-2232">
                                    <label class="fr-label" for="segmented-2232-3">
                                        Libellé
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2234">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2234">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented"&gt;
    &lt;legend class="fr-segmented__legend"&gt;
        Légende
    &lt;/legend&gt;
    &lt;div class="fr-segmented__elements"&gt;
        &lt;div class="fr-segmented__element"&gt;
            &lt;input value="1" type="radio" id="segmented-2233-1" name="segmented-2233"&gt;
            &lt;label class="fr-label" for="segmented-2233-1"&gt;
                Libellé
            &lt;/label&gt;
        &lt;/div&gt;
        &lt;div class="fr-segmented__element"&gt;
            &lt;input value="2" checked type="radio" id="segmented-2233-2" name="segmented-2233"&gt;
            &lt;label class="fr-label" for="segmented-2233-2"&gt;
                Libellé
            &lt;/label&gt;
        &lt;/div&gt;
        &lt;div class="fr-segmented__element"&gt;
            &lt;input value="3" disabled type="radio" id="segmented-2233-3" name="segmented-2233"&gt;
            &lt;label class="fr-label" for="segmented-2233-3"&gt;
                Libellé
            &lt;/label&gt;
        &lt;/div&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
                    ...
                    <div class="fr-mt-0">
                        <h2>Contrôle segmenté cas maximum (non recommandé)</h2>
                        <p>Lorsque la largeur du contrôle segmenté dépasse celle de son conteneur, la légende ne reste pas sur la même ligne. Si cela ne rentre toujours pas, les boutons passent en vertical. Réduisez la fenêtre pour voir le comportement de ce script.</p>
                    </div>
                    <div class="fr-mb-6v">
                        <fieldset class="fr-segmented">
                            <legend class="fr-segmented__legend fr-segmented__legend--inline">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-2235">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-2235">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-segmented"&gt;
    &lt;legend class="fr-segmented__legend fr-segmented__legend--inline"&gt;
        Légende
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-2236">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-2237" title="Fermer">
                                Fermer
                            </button>
                        </div>
    ...
    <script type="module" src="../../../dist/component/segmented/segmented.module.js"></script>
    ...
    <script type="text/javascript" nomodule src="../../../dist/component/segmented/segmented.nomodule.js"></script>
