...
<head>
    ...
    <link href="../../../dist/component/upload/upload.print.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Ajout de fichier (upload)</h1>
        <p>Ce composant permet aux utilisateurs de sélectionner et envoyer un ou plusieurs fichiers.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/ajout-de-fichier" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Bouton upload 1 seul fichier</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-upload-group" id="upload-group-1151">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1153">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1153">
                                <pre class=" language-html"><code>&lt;div class="fr-upload-group" id="upload-group-1152"&gt;
    &lt;label class="fr-label" for="file-upload"&gt;
        Ajouter un fichier
        &lt;span class="fr-hint-text"&gt;Indication : taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Bouton upload avec erreur</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-upload-group fr-upload-group--error" id="upload-group-1154">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1156">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1156">
                                <pre class=" language-html"><code>&lt;div class="fr-upload-group fr-upload-group--error" id="upload-group-1155"&gt;
    &lt;label class="fr-label" for="file-upload-with-error"&gt;
        Ajouter un fichier
        &lt;span class="fr-hint-text"&gt;Indication : taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Bouton upload fichiers multiples</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-upload-group" id="upload-group-1157">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1159">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1159">
                                <pre class=" language-html"><code>&lt;div class="fr-upload-group" id="upload-group-1158"&gt;
    &lt;label class="fr-label" for="file-upload-multiple"&gt;
        Ajouter des fichiers
        &lt;span class="fr-hint-text"&gt;Indication : taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <h3>Bouton upload désactivé</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-upload-group fr-upload-group--disabled" id="upload-group-1160">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1162">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1162">
                                <pre class=" language-html"><code>&lt;div class="fr-upload-group fr-upload-group--disabled" id="upload-group-1161"&gt;
    &lt;label class="fr-label" for="file-upload-disabled"&gt;
        Ajouter un fichier
        &lt;span class="fr-hint-text"&gt;Indication : taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-1163">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-1164" title="Fermer">
                                Fermer
                            </button>
                        </div>
