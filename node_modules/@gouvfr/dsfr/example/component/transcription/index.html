...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/transcription" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    <h3>Transcription avec zone d’action</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-transcription" id="transcription-7426">
                            <button class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-7426">Transcription</button>
                            <div class="fr-collapse" id="fr-transcription-collapse-transcription-7426">
                                <div class="fr-transcription__footer">
                                    <div class="fr-transcription__actions-group">
                                        <button class="fr-btn--fullscreen fr-btn" aria-controls="fr-transcription-modal-transcription-7426" aria-label="Agrandir la transcription" data-fr-opened="false" id="button-7428">
                                            Agrandir
                                        </button>
                                    </div>
                                </div>
                                <div id="fr-transcription-modal-transcription-7426" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-7426-title">
                                    <div class="fr-container fr-container--fluid fr-container-md">
                                        <div class="fr-grid-row fr-grid-row--center">
                                            <div class="fr-col-12 fr-col-md-10 fr-col-lg-8">
                                                <div class="fr-modal__body">
                                                    <div class="fr-modal__header">
                                                        <button class="fr-btn--close fr-btn" aria-controls="fr-transcription-modal-transcription-7426" id="button-7429" title="Fermer">
                                                            Fermer
                                                        </button>
                                                    </div>
                                                    <div class="fr-modal__content">
                                                        <h1 id="fr-transcription-modal-transcription-7426-title" class="fr-modal__title">
                                                            Titre de la vidéo
                                                        </h1>
                                                        <!-- données de test -->
                                                        <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7434">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7434">
                                <pre class=" language-html"><code>&lt;div class="fr-transcription" id="transcription-7430"&gt;
    &lt;button class="fr-transcription__btn" aria-expanded="false" aria-controls="fr-transcription-collapse-transcription-7430"&gt;Transcription&lt;/button&gt;
    &lt;div class="fr-collapse" id="fr-transcription-collapse-transcription-7430"&gt;
        &lt;div class="fr-transcription__footer"&gt;
            &lt;div class="fr-transcription__actions-group"&gt;
                &lt;button class="fr-btn--fullscreen fr-btn" aria-controls="fr-transcription-modal-transcription-7430" aria-label="Agrandir la transcription" data-fr-opened="false" id="button-7432"&gt;
                    Agrandir
                &lt;/button&gt;
            &lt;/div&gt;
        &lt;/div&gt;
        &lt;div id="fr-transcription-modal-transcription-7430" class="fr-modal" aria-labelledby="fr-transcription-modal-transcription-7430-title"&gt;
            &lt;div class="fr-container fr-container--fluid fr-container-md"&gt;
                &lt;div class="fr-grid-row fr-grid-row--center"&gt;
                    &lt;div class="fr-col-12 fr-col-md-10 fr-col-lg-8"&gt;
                        &lt;div class="fr-modal__body"&gt;
                            &lt;div class="fr-modal__header"&gt;
                                &lt;button class="fr-btn--close fr-btn" aria-controls="fr-transcription-modal-transcription-7430" id="button-7433" title="Fermer"&gt;
                                    Fermer
                                &lt;/button&gt;
                            &lt;/div&gt;
                            &lt;div class="fr-modal__content"&gt;
                                &lt;h1 id="fr-transcription-modal-transcription-7430-title" class="fr-modal__title"&gt;
                                    Titre de la vidéo
                                &lt;/h1&gt;
                                &lt;!-- données de test --&gt;
                            &lt;/div&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7435">
        Label bouton
    </button>
        ...
        <div class="fr-container fr-container--fluid fr-container-md">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7436" title="Fermer">
                                Fermer
                            </button>
                        </div>
                        <div class="fr-modal__content">
    ...
    <script type="module" src="../../../dist/component/transcription/transcription.module.js"></script>
    ...
    <script type="text/javascript" nomodule src="../../../dist/component/transcription/transcription.nomodule.js"></script>
