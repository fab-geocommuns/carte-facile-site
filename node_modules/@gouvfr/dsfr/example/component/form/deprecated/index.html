...
<body id="top" class="fr-mb-12w">
  ...
  function preventSubmit(e) {
                            ...
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-input-group" id="input-group-3947">
                                        ...
                                        <div class="fr-input-group" id="input-group-3948">
                                        ...
                                        <div class="fr-input-group" id="input-group-3949">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3953">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3953">
    ...
    &lt;fieldset class="fr-fieldset"&gt;
        ...
        &lt;/legend&gt;
        &lt;div class="fr-fieldset__content"&gt;
            &lt;div class="fr-input-group" id="input-group-3950"&gt;
                &lt;label class="fr-label" for="text-deprecated-1"&gt;
                    Libellé champ de saisie
                &lt;/label&gt;
                &lt;input class="fr-input" aria-describedby="text-deprecated-1-messages" name="text-deprecated" id="text-deprecated-1" type="text"&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group" id="input-group-3951"&gt;
                &lt;label class="fr-label" for="text-deprecated-2"&gt;
                    Libellé champ de saisie
                &lt;/label&gt;
                &lt;input class="fr-input" aria-describedby="text-deprecated-2-messages" name="text-deprecated" id="text-deprecated-2" type="text"&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group" id="input-group-3952"&gt;
                &lt;label class="fr-label" for="text-deprecated-3"&gt;
                    Libellé champ de saisie
                &lt;/label&gt;
                &lt;input class="fr-input" aria-describedby="text-deprecated-3-messages" name="text-deprecated" id="text-deprecated-3" type="text"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3954">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3954">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3955">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3955">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3956">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3956">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-inline-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3957">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3957">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-inline-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3958">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3958">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="radio-error-deprecated-legend radio-error-deprecated-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-error-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3959">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3959">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3960">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3960">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkbox-error-deprecated-legend checkbox-error-deprecated-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-error-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                                    ...
                                    <div class="fr-fieldset__content">
                                        <div class="fr-input-group fr-input-group--disabled" id="input-group-3961">
                                        ...
                                        <div class="fr-input-group fr-input-group--disabled" id="input-group-3962">
                                        ...
                                        <div class="fr-input-group fr-input-group--disabled" id="input-group-3963">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3967">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3967">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend" id='text-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
        ...
        &lt;/legend&gt;
        &lt;div class="fr-fieldset__content"&gt;
            &lt;div class="fr-input-group fr-input-group--disabled" id="input-group-3964"&gt;
                &lt;label class="fr-label" for="text-disabled-deprecated-1"&gt;
                    Libellé champ de saisie
                    &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
                &lt;/label&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group fr-input-group--disabled" id="input-group-3965"&gt;
                &lt;label class="fr-label" for="text-disabled-deprecated-2"&gt;
                    Libellé champ de saisie
                    &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
                &lt;/label&gt;
                ...
                &lt;/div&gt;
            &lt;/div&gt;
            &lt;div class="fr-input-group fr-input-group--disabled" id="input-group-3966"&gt;
                &lt;label class="fr-label" for="text-disabled-deprecated-3"&gt;
                    Libellé champ de saisie
                    &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
                &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3968">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3968">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3969">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3969">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkbox-disabled-deprecated-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-3970">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-3971" title="Fermer">
                                Fermer
                            </button>
                        </div>
