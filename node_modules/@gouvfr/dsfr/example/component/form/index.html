...
<head>
    ...
    <link href="../../../dist/component/select/select.legacy.css" rel="stylesheet">
    ...
    <link href="../../../dist/component/select/select.print.css" rel="stylesheet">
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Formulaire (form)</h1>
        <p>Ce package permet de mettre en forme les différents champs d'un formulaire, notamment en ce qui concerne les espacements et texte d'aide et d'erreur.</p>
    </div>
    <div class="fr-mb-12w">
  ...
  function preventSubmit(e) {
    ...
    return false;
                    ...
                    <form onsubmit="return preventSubmit(event)">
                        <h3>Ensemble de champs de saisie</h3>
                        <div class="fr-mb-6v">
                            <fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3916">
                                        <label class="fr-label" for="text-1">
                                            Libellé champ de saisie
                                        </label>
                                        <input class="fr-input" aria-describedby="text-1-messages" name="text" id="text-1" type="text">
                                        <div class="fr-messages-group" id="text-1-messages" aria-live="polite">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3917">
                                        <label class="fr-label" for="text-2">
                                            Libellé champ de saisie
                                        </label>
                                        <input class="fr-input" aria-describedby="text-2-messages" name="text" id="text-2" type="text">
                                        <div class="fr-messages-group" id="text-2-messages" aria-live="polite">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3918">
                                        <label class="fr-label" for="text-3">
                                            Libellé champ de saisie
                                        </label>
                                        <input class="fr-input" aria-describedby="text-3-messages" name="text" id="text-3" type="text">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3922">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3922">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="text" aria-labelledby="text-legend text-messages"&gt;
    &lt;legend class="fr-fieldset__legend" id="text-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3919"&gt;
            &lt;label class="fr-label" for="text-1"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-1-messages" name="text" id="text-1" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3920"&gt;
            &lt;label class="fr-label" for="text-2"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-2-messages" name="text" id="text-2" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3921"&gt;
            &lt;label class="fr-label" for="text-3"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-3-messages" name="text" id="text-3" type="text"&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3923">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3923">
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de cases à cocher</h3>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3924">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3924">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkbox" aria-labelledby="checkbox-legend checkbox-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkbox-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3925">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3925">
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de cases à cocher, en ligne</h3>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3926">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3926">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkbox-inline" aria-labelledby="checkbox-inline-legend checkbox-inline-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkbox-inline-legend"&gt;
        Légende pour l’ensemble des éléments
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element fr-fieldset__element--inline"&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3927">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3927">
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de boutons radio riches</h3>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3928">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3928">
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de cases à cocher, avec erreur</h3>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3929">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3929">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset fr-fieldset--error" id="checkbox-error" role="group" aria-labelledby="checkbox-error-legend checkbox-error-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkbox-error-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de champs de saisie désactivés</h3>
                        <div class="fr-mb-6v">
                            <fieldset class="fr-fieldset" id="text-disabled" disabled aria-labelledby="text-disabled-legend text-disabled-messages">
                                ...
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3930">
                                        <label class="fr-label" for="text-disabled-1">
                                            Libellé champ de saisie
                                            <span class="fr-hint-text">Texte de description additionnel</span>
                                        </label>
                                        <input class="fr-input" aria-describedby="text-disabled-1-messages" name="text-disabled" id="text-disabled-1" type="text">
                                        <div class="fr-messages-group" id="text-disabled-1-messages" aria-live="polite">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3931">
                                        <label class="fr-label" for="text-disabled-2">
                                            Libellé champ de saisie
                                            <span class="fr-hint-text">Texte de description additionnel</span>
                                        </label>
                                        <input class="fr-input" aria-describedby="text-disabled-2-messages" name="text-disabled" id="text-disabled-2" type="text">
                                        <div class="fr-messages-group" id="text-disabled-2-messages" aria-live="polite">
                                        </div>
                                    </div>
                                </div>
                                <div class="fr-fieldset__element">
                                    <div class="fr-input-group" id="input-group-3932">
                                        <label class="fr-label" for="text-disabled-3">
                                            Libellé champ de saisie
                                            <span class="fr-hint-text">Texte de description additionnel</span>
                                        </label>
                                        <input class="fr-input" aria-describedby="text-disabled-3-messages" name="text-disabled" id="text-disabled-3" type="text">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3936">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3936">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="text-disabled" disabled aria-labelledby="text-disabled-legend text-disabled-messages"&gt;
    &lt;legend class="fr-fieldset__legend" id="text-disabled-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3933"&gt;
            &lt;label class="fr-label" for="text-disabled-1"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3934"&gt;
            &lt;label class="fr-label" for="text-disabled-2"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-3935"&gt;
            &lt;label class="fr-label" for="text-disabled-3"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de boutons radio désactivés</h3>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3937">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3937">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="radio-disabled" disabled aria-labelledby="radio-disabled-legend radio-disabled-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="radio-disabled-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                        ...
                        <h3>Ensemble de cases à cocher désactivés</h3>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3938">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3938">
                                    <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="checkbox-disabled" disabled aria-labelledby="checkbox-disabled-legend checkbox-disabled-messages"&gt;
    &lt;legend class="fr-fieldset__legend--regular fr-fieldset__legend" id="checkbox-disabled-legend"&gt;
        Légende pour l’ensemble des éléments
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/legend&gt;
...
&lt;/fieldset&gt;
                        ...
                        <h3>Bouton type submit</h3>
                        <div class="fr-mb-6v">
                            <button class="fr-btn" id="button-3939" title="Envoyer le formulaire" type="submit">
                                Envoyer
                            </button>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3941">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3941">
                                    <pre class=" language-html"><code>&lt;button class="fr-btn" id="button-3940" title="Envoyer le formulaire" type="submit"&gt;
    Envoyer
&lt;/button&gt;
</code></pre>
                                </div>
                        ...
                        <div class="fr-mb-6v">
                            <input class="fr-btn" value="Envoyer" title="Envoyer le formulaire" id="button-3942" type="submit">
                            </input>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-3944">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-3944">
                                    <pre class=" language-html"><code>&lt;input class="fr-btn" value="Envoyer" title="Envoyer le formulaire" id="button-3943" type="submit"&gt;
&lt;/input&gt;
</code></pre>
                                </div>
                            </section>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-3945">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-3946" title="Fermer">
                                Fermer
                            </button>
                        </div>
