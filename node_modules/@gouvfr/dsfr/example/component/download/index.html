...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-mb-12w">
        <div class="fr-container">
            ...
            <ul>
                <li>
                    <a href="../card/download/">Carte de téléchargement</a>
                </li>
                <li>
                    <a href="../link/download/">lien de téléchargement</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7369">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7370" title="Fermer">
                                Fermer
                            </button>
                        </div>
