...
<head>
    ...
    <title>Tableaux - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Tableaux (table)</h1>
        <p>Les tableaux sont utilisés pour organiser et afficher les informations d'un jeu de données.</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/composants/tableau" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <h3>Tableau par défaut</h3>
            <div class="fr-mb-6v">
                <div class="fr-table" id="table-7138">
                    <table>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7140">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7140">
                        <pre class=" language-html"><code>&lt;div class="fr-table" id="table-7139"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption du tableau (accessibilité)&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau avec bordure</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--bordered" id="table-7141">
                    <table>
                        <caption>Caption du tableau (accessibilité)</caption>
                        <thead>
                            <tr>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7143">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7143">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--bordered" id="table-7142"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption du tableau (accessibilité)&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau non scrollable</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--no-scroll" id="table-7144">
                    <table>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7146">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7146">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--no-scroll" id="table-7145"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption tableau non scrollable&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau colonnes fixées (layout-fixed)</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--layout-fixed" id="table-7147">
                    <table>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7149">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7149">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--layout-fixed" id="table-7148"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption tableau fixé&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau caption invisible</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--no-caption" id="table-7150">
                    <table>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7152">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7152">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--no-caption" id="table-7151"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption cachée&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau caption Bottom</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--caption-bottom" id="table-7153">
                    <table>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7155">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7155">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--caption-bottom" id="table-7154"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption en bas&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau accentué</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--green-emeraude" id="table-7156">
                    <table>
                        <caption>Caption du tableau (accessibilité)</caption>
                        <thead>
                            <tr>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7158">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7158">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--green-emeraude" id="table-7157"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption du tableau (accessibilité)&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
            ...
            <h3>Tableau accentué avec bordure</h3>
            <div class="fr-mb-6v">
                <div class="fr-table fr-table--green-emeraude fr-table--bordered" id="table-7159">
                    <table>
                        <caption>Caption du tableau (accessibilité)</caption>
                        <thead>
                            <tr>
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7161">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-7161">
                        <pre class=" language-html"><code>&lt;div class="fr-table fr-table--green-emeraude fr-table--bordered" id="table-7160"&gt;
    &lt;table&gt;
        &lt;caption&gt;Caption du tableau (accessibilité)&lt;/caption&gt;
        &lt;thead&gt;
            &lt;tr&gt;
...
&lt;/div&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7162">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7163" title="Fermer">
                                Fermer
                            </button>
                        </div>
