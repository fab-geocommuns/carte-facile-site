            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1037">Intitulé accordéon</button>
                            </h3>
                            <div class="fr-collapse" id="accordion-1037">
                                <!-- données de test -->
                                <div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1039">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1039">
                                <pre class=" language-html"><code>&lt;section class="fr-accordion"&gt;
    &lt;h3 class="fr-accordion__title"&gt;
        &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1038"&gt;Intitulé accordéon&lt;/button&gt;
    &lt;/h3&gt;
    &lt;div class="fr-collapse" id="accordion-1038"&gt;
        &lt;!-- données de test --&gt;
    &lt;/div&gt;
&lt;/section&gt;
</code></pre>
                    ...
                    <h3>Groupe d‘accordéons</h3>
                    <div class="fr-mb-6v">
                        <div class="fr-accordions-group">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1040">Intitulé accordéon</button>
                                </h3>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1041">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-1041">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1042">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-1042">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <ul>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1043">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-1043">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1044">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-1044">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                            ...
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1045">Intitulé accordéon</button>
                                </h3>
                                <div class="fr-collapse" id="accordion-1045">
                                    <!-- données de test -->
                                    <div>
                                        <h4 class="fr-h4">Contenu </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing, <a href="https://www.systeme-de-design.gouv.fr/" target="_blank">link test</a> incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1052">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-1052">
                                <pre class=" language-html"><code>&lt;div class="fr-accordions-group"&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1046"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-1046"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1047"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
        &lt;div class="fr-collapse" id="accordion-1047"&gt;
            &lt;!-- données de test --&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1048"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
    ...
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1049"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
    ...
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1050"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
    ...
    &lt;section class="fr-accordion"&gt;
        &lt;h3 class="fr-accordion__title"&gt;
            &lt;button class="fr-accordion__btn" aria-expanded="false" aria-controls="accordion-1051"&gt;Intitulé accordéon&lt;/button&gt;
        &lt;/h3&gt;
...
&lt;/div&gt;
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <ul>
            <li>
                <a href="imbrication">Imbrication d&#39;accordéons</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-1053">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-1054" title="Fermer">
                                Fermer
                            </button>
                        </div>
