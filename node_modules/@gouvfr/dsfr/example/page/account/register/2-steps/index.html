...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        <h3>Pages de création de compte</h3>
        <ul>
            <li>
                <a href="2a-login">Étape 1 - Formulaires de création de compte - identifiant</a>
            </li>
            <li>
                <a href="2b-identity">Étape 2 - Formulaires de création de compte - identité</a>
            </li>
            <li>
                <a href="2c-address">Étape 3 - Formulaires de création de compte - coordonnées</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-9348">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-9349" title="Fermer">
                                Fermer
                            </button>
                        </div>
