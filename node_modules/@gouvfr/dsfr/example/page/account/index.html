...
<head>
    ...
    <title>Connexion et création de compte - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Connexion et création de compte (account)</h1>
        <p>Modèles de pages de connexion et création de compte</p>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./login/'>Pages de connexion (login)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./register/'>Pages de création de compte (register)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./recover/'>Pages de récupération de mot de passe (recover)</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-8777">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-8778" title="Fermer">
                                Fermer
                            </button>
                        </div>
