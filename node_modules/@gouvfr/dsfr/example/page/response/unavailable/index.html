...
<head>
    ...
    <title>Modèle de page service indisponible - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Modèle de page service indisponible (unavailable)</h1>
    </div>
    <div class="fr-mb-12w">
        <div class="fr-container">
            <div class="fr-mt-32v">
                <h2>à noter</h2>
                <p>Ce modèle de page est disponible uniquement en version standalone.
                    <br>Pour la tester, veuillez éxécuter la commande
                    <br>
                    <i>yarn standalone -p unavailable</i>
                </p>
            </div>
        </div>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-8775">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-8776" title="Fermer">
                                Fermer
                            </button>
                        </div>
