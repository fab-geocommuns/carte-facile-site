...
<head>
    ...
    <title>Codes de Statut HTML - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Codes de Statut HTML (response)</h1>
        <p>Modèles de pages correspondant aux réponses de statut HTML</p>
        <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/modeles/page-d-erreurs" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre">Documentation</a>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./unexpected/'>Modèle de page erreur inattendue (unexpected)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./not-found/'>Modèle de page ressource non trouvée (not-found)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./unavailable/'>Modèle de page service indisponible (unavailable)</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7737">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7738" title="Fermer">
                                Fermer
                            </button>
                        </div>
