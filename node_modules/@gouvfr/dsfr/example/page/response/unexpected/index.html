...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        <h3>Page Erreur 500</h3>
        <ul>
            <li>
                <a href="contact">Page Erreur 500, avec contact</a>
            </li>
            <li>
                <a href="default">Page Erreur 500, simple</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-7739">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-7740" title="Fermer">
                                Fermer
                            </button>
                        </div>
