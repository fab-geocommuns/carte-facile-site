...
<head>
    ...
    <title>Pictogrammes Institutions - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Pictogrammes Institutions (pictograms-institutions)</h1>
    </div>
    <div class="fr-mb-12w">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11301">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11301">
...
&lt;/svg&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11302">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11302">
                                <pre class=" language-html"><code>&lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    &lt;use class="fr-artwork-decorative" href="../../../../dist/artwork/pictograms/institutions/gendarmerie.svg#artwork-decorative"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-minor" href="../../../../dist/artwork/pictograms/institutions/gendarmerie.svg#artwork-minor"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-major" href="../../../../dist/artwork/pictograms/institutions/gendarmerie.svg#artwork-major"&gt;&lt;/use&gt;
&lt;/svg&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11303">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11303">
                                <pre class=" language-html"><code>&lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    &lt;use class="fr-artwork-decorative" href="../../../../dist/artwork/pictograms/institutions/justice.svg#artwork-decorative"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-minor" href="../../../../dist/artwork/pictograms/institutions/justice.svg#artwork-minor"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-major" href="../../../../dist/artwork/pictograms/institutions/justice.svg#artwork-major"&gt;&lt;/use&gt;
&lt;/svg&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11304">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11304">
                                <pre class=" language-html"><code>&lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    &lt;use class="fr-artwork-decorative" href="../../../../dist/artwork/pictograms/institutions/money.svg#artwork-decorative"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-minor" href="../../../../dist/artwork/pictograms/institutions/money.svg#artwork-minor"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-major" href="../../../../dist/artwork/pictograms/institutions/money.svg#artwork-major"&gt;&lt;/use&gt;
&lt;/svg&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11305">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11305">
                                <pre class=" language-html"><code>&lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    &lt;use class="fr-artwork-decorative" href="../../../../dist/artwork/pictograms/institutions/police.svg#artwork-decorative"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-minor" href="../../../../dist/artwork/pictograms/institutions/police.svg#artwork-minor"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-major" href="../../../../dist/artwork/pictograms/institutions/police.svg#artwork-major"&gt;&lt;/use&gt;
&lt;/svg&gt;
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-11306">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-11307" title="Fermer">
                                Fermer
                            </button>
                        </div>
