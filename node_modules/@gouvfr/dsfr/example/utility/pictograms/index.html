...
<head>
    ...
    <title>Utilitaires de pictogrammes - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Utilitaires de pictogrammes (pictograms)</h1>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./pictograms-buildings/'>Pictogrammes Buildings (pictograms-buildings)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-digital/'>Pictogrammes Digital (pictograms-digital)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-document/'>Pictogrammes Document (pictograms-document)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-environment/'>Pictogrammes Environment (pictograms-environment)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-health/'>Pictogrammes Health (pictograms-health)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-institutions/'>Pictogrammes Institutions (pictograms-institutions)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-leisure/'>Pictogrammes Leisure (pictograms-leisure)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-map/'>Pictogrammes Map (pictograms-map)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms-system/'>Pictogrammes Système (pictograms-system)</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-11253">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-11254" title="Fermer">
                                Fermer
                            </button>
                        </div>
