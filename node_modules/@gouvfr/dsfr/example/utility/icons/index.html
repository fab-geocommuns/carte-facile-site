...
<head>
    ...
    <title>Utilitaires d&#39;icônes - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Utilitaires d&#39;icônes (icons)</h1>
    ...
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./icons-buildings/'>Icônes Buildings (icons-buildings)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-business/'>Icônes Business (icons-business)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-communication/'>Icônes Communication (icons-communication)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-design/'>Icônes Design (icons-design)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-development/'>Icônes Development (icons-development)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-device/'>Icônes Device (icons-device)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-document/'>Icônes Document (icons-document)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-editor/'>Icônes Editor (icons-editor)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-finance/'>Icônes Finance (icons-finance)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-health/'>Icônes Health (icons-health)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-logo/'>Icônes Logo (icons-logo)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-map/'>Icônes Map (icons-map)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-media/'>Icônes Media (icons-media)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-others/'>Icônes Others (icons-others)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-system/'>Icônes System (icons-system)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-user/'>Icônes User (icons-user)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./icons-weather/'>Icônes Weather (icons-weather)</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-10614">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-10615" title="Fermer">
                                Fermer
                            </button>
                        </div>
