...
<head>
    ...
    <title>Icônes Weather - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Icônes Weather (icons-weather)</h1>
            ...
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11243">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11243">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-cloudy-2-fill" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>cloudy-2-line [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11244">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11244">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-cloudy-2-line" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>flashlight-fill [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11245">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11245">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-flashlight-fill" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>flashlight-line [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11246">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11246">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-flashlight-line" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>moon-fill [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11247">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11247">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-moon-fill" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>moon-line [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11248">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11248">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-moon-line" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>sun-fill [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11249">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11249">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-sun-fill" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
                    <h3>sun-line [remix]</h3>
                    <div class="fr-mb-6v">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11250">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11250">
                                <pre class=" language-html"><code>&lt;span class="fr-icon-sun-line" aria-hidden="true"&gt;&lt;/span&gt;
</code></pre>
                            </div>
                        </section>
                    </div>
    ...
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-11251">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-11252" title="Fermer">
                                Fermer
                            </button>
                        </div>
