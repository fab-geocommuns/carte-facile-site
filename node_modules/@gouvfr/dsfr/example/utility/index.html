...
<head>
    ...
    <title>Utilitaire - Système de design</title>
...
<body id="top" class="fr-mb-12w">
    ...
    <div class="fr-container fr-mt-2v fr-mb-8w">
        ...
        <h1>Utilitaire (utility)</h1>
        <p>Le package utility apporte des utilitaires optionnels et complémentaires aux fondamentaux.
            <br />
            <br />### Icônes
            <br />
            <br />Les icônes fonctionnelles sont des symboles visuels qui accompagnent l’utilisateur dans ses actions et qui aident à sa compréhension de l’interface.
            <br />
        </p>
        <h5>Documentation</h5>
        <ul>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/fondamentaux-techniques/icones" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre"> Icônes</a>
            </li>
            <li>
                <a href="https://www.systeme-de-design.gouv.fr/elements-d-interface/fondamentaux-techniques/pictogramme" target="_blank" rel="noopener external" title="[À MODIFIER - Intitulé] - nouvelle fenêtre"> Pictogramme</a>
            </li>
        </ul>
    </div>
    <div class="fr-container">
        <ul class="fr-col-12">
            <li class="fr-mb-1w">
                <a href='./icons/'>Utilitaires d&#39;icônes (icons)</a>
            </li>
            <li class="fr-mb-1w">
                <a href='./pictograms/'>Utilitaires de pictogrammes (pictograms)</a>
            </li>
        </ul>
    </div>
    <button class="fr-display-button fr-background-default--grey fr-btn fr-btn--lg fr-icon-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false" style="z-index: 1600" id="button-10612">
        Label bouton
    </button>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button class="fr-btn--close fr-btn" aria-controls="fr-theme-modal" id="button-10613" title="Fermer">
                                Fermer
                            </button>
                        </div>
